...
predictorNames = {'wellnum', 'wellName', 'x0', 'strain', 'ageDpf', 'nFish', 'minutesIncubation', 'avgTD', 'seTD'};
predictors = inputTable(:, predictorNames);
response = inputTable.DMSO;
isCategoricalPredictor = [false, true, false, true, false, false, false, false, false];
...
trainedClassifier.RequiredVariables = {'wellnum', 'wellName', 'x0', 'strain', 'ageDpf', 'nFish', 'minutesIncubation', 'avgTD', 'seTD'};
